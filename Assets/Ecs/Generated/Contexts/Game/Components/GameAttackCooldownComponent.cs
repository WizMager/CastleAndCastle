...
{
	public Ecs.Game.Components.Units.AttackCooldownComponent AttackCooldown { get { return (Ecs.Game.Components.Units.AttackCooldownComponent)GetComponent(GameComponentsLookup.AttackCooldown); } }
	...
	public void AddAttackCooldown(float newValue)
	{
		...
		var component = (Ecs.Game.Components.Units.AttackCooldownComponent)CreateComponent(index, typeof(Ecs.Game.Components.Units.AttackCooldownComponent));
	...
	public void CopyAttackCooldownTo(Ecs.Game.Components.Units.AttackCooldownComponent copyComponent)
	{
		var index = GameComponentsLookup.AttackCooldown;
		var component = (Ecs.Game.Components.Units.AttackCooldownComponent)CreateComponent(index, typeof(Ecs.Game.Components.Units.AttackCooldownComponent));
		#if !ENTITAS_REDUX_NO_IMPL
